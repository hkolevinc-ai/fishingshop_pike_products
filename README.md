...
- извлича номер/код на продукт, име, категория, описание, URL, цена, тегло и наличност;
...
| Колона | Описание |
|---|---|
| `product_number` | Номер/код на продукта от полето „Код“ |
